...
export const landingStyles = StyleSheet.create({
  ...
  exampleGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 18, justifyContent: 'center' },
  exampleCard: { flexGrow: 1, flexBasis: '23%' as any, minWidth: 230, maxWidth: 360, backgroundColor: colors.surface, borderRadius: spacing.radiusLg, overflow: 'hidden', borderWidth: 1, borderColor: colors.border },
  ...
  stepsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 18, justifyContent: 'center' },
  stepCard: { flexGrow: 1, flexBasis: '30%' as any, minWidth: 220, maxWidth: 360, padding: 22, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: spacing.radiusLg },
  stepIcon: { width: 58, height: 58, borderRadius: 18, backgroundColor: colors.periwinkleSoft, alignItems: 'center', justifyContent: 'center', alignSelf: 'center', marginBottom: 18 },
  stepNumber: { color: colors.periwinkle, fontSize: 12, fontWeight: '900', letterSpacing: 1, textAlign: 'center' },
  ...
  faqList: { gap: 12 },
  faqItem: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: spacing.radiusLg, overflow: 'hidden' },
  faqQuestionRow: { minHeight: 68, paddingHorizontal: 20, paddingVertical: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 16 },
  faqQuestion: { color: colors.text, fontSize: 16, fontWeight: '800', flex: 1 },
  faqChevronOpen: { transform: [{ rotate: '180deg' }] },
  faqAnswerWrap: { paddingHorizontal: 20, paddingBottom: 20 },
  faqAnswer: { color: colors.textSecondary, fontSize: 14, lineHeight: 21, maxWidth: 680 },
